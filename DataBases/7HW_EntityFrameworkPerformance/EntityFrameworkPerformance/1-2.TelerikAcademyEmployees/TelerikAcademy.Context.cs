...
namespace _1_2.TelerikAcademyEmployees
{
    ...
    public partial class TelerikAcademyEntities : DbContext
    {
        ...
        public DbSet<Users_logged_in_today> Users_logged_in_todays { get; set; }
        ...
        public virtual int EmpDump()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EmpDump");
        }
