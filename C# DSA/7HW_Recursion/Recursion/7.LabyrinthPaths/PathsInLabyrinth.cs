...
class Program
{
    ...
    //Note: For task number 8 - try with this labyrinth and comment out
    //the part with the mariking of current cell as free (check comment below)
    //static char[,] lab =
    //{
    //      {' ','*',' ',' ',' ',' ','*',' ',' ',' ',' ','*','*',' ',' '},
    //      {' ',' ','*',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '},
    ...
    static void FindPath(int row, int col, char direction)
    {
        ...
        if (lab[row, col] == ' ')
        {
            ...
            //***************************************
            //8 task here - comment out the next line 
            lab[row, col] = ' ';
        }
