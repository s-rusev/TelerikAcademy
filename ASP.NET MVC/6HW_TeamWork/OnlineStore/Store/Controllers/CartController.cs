...
namespace Store.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public ActionResult Purchase(int id, FormCollection orderProperties)
        {
            Order order = db.Orders.Include(o => o.OrderedProducts.Select(p => p.Product)).Where(o => o.Id == id).FirstOrDefault();
            if (order != null)
            {
                ...
                {
                    TempData["ErrorMessage"] = "The order is already purchased. It can't be purchased for second time.";
                }
            }
            else
            {
                TempData["ErrorMessage"] = "There is no other found. Please try again.";
            }
