...
namespace FallingRocks
{
    class FallingRocks
    {
        ...
        {
            score = -29; // increases with each line of falling rocks
            Console.SetWindowSize(30, 30);  //don't change it to non-square matrix ... will break :/
            Console.BufferWidth = Console.WindowWidth;
            Console.BufferHeight = Console.WindowHeight;
            Console.ForegroundColor = ConsoleColor.Cyan;

            gameField = new char[Console.WindowWidth, Console.WindowHeight];
            ...
            gameField[gameField.GetLength(1) - 1, dwarfPosition - 1] = '(';
            gameField[gameField.GetLength(1) - 1, dwarfPosition] = 'O';
            gameField[gameField.GetLength(1) - 1, dwarfPosition + 1] = ')';
        ...
        static void MoveDwarfLeft()
        {
            ...
            {
                dwarfPosition--;
                gameField[gameField.GetLength(1) - 1, dwarfPosition + 2] = ' ';
                gameField[gameField.GetLength(1) - 1, dwarfPosition - 1] = '(';
                gameField[gameField.GetLength(1) - 1, dwarfPosition] = 'O';
                gameField[gameField.GetLength(1) - 1, dwarfPosition + 1] = ')';
        ...
        {
            if (dwarfPosition < gameField.GetLength(0) - 3)
            {
                dwarfPosition++;
                gameField[gameField.GetLength(1) - 1, dwarfPosition - 2] = ' ';
                gameField[gameField.GetLength(1) - 1, dwarfPosition - 1] = '(';
        ...
        static void DrawField()
        {
            ...
            {
                for (int j = 0; j < gameField.GetLength(0) - 1; j++)
                {
                    Console.Write(gameField[i, j]);
                }
                if (i == gameField.GetLength(1) - 1)
                {
                    continue;
                }
                Console.WriteLine();
